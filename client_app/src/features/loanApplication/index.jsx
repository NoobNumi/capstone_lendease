  ...
  return (
    <div className="inline-block float-right">
      ...
      <button
        ...
        onClick={() => document.getElementById("addLoan").showModal()}
      >
        Add
...
function LoanApplication() {
    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ row, value }) => {
          return (
            <span className="">
              {value && format(value, "MMM dd, yyyy hh:mm a")}
            </span>
          );
        },
      },
  ...
  const formikConfig = (selectedUser, loanType) => {
    ...
    return {
      ...
      onSubmit: async (
        values,
        { setFieldError, setSubmitting, resetForm, isSubmitting }
      ) => {
        setSubmitting(true);
        ...
        try {
          ...
          let data = {
            ...
            employee_monthly_income_amount:
              values.employee_monthly_income_amount,
          ...
          const sections = [
            ...
            },
            {
              ...
              fields: [
                ...
                `Income Flow: ${data.income_flow}`,
                `Income Amount: ${
                  data.income_amount || data.employee_monthly_income_amount
                }`,
                `Monthly Pension Amount: ${data.monthly_pension_amount}`,
              ],
            },
        ...
        <div className="">
                    ...
                    <Formik {...formikConfig(selectedUser, loanType)}>
                      {({
                                ...
                                <div>
                                      ...
                                      <div className="mt-4 col-span-2">
                                        <div className="bg-yellow-100 border border-yellow-500 text-yellow-700 p-4 rounded">
                                          ...
                                          <p>
                                            ...
                                            double-check your bank or e-wallet
                                            details. Disbursements are
                                  ...
                                  /> */}
                                        ...
                                        <InputText
                                          ...
                                          type="text"
                                          value={
                                            values.disbursement_account_name
                                          }
                                          onBlur={handleBlur}
                                        ...
                                        <InputText
                                          ...
                                          type="text"
                                          value={
                                            values.disbursement_account_number
                                          }
                                          onBlur={handleBlur}
                              ...
                              <Form className="">
                                <LoanCalculator
                                  ...
                                  calculatorLoanAmmount={
                                    values.calculatorLoanAmmount
                                  }
                                  calculatorInterestRate={
                                    values.calculatorInterestRate
                                  }
                                  calculatorMonthsToPay={
                                    values.calculatorMonthsToPay
                                  }
                                  calculatorTotalAmountToPay={
                                    values.calculatorTotalAmountToPay
                                  }
                                />
                              </Form>
                            </div>
                            ...
                            <div className="mt-8 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-lg shadow-md w-full">
                              <div className="flex justify-between items-start">
                                <div>
                                  ...
                                  <p className="mt-2">
                                    Collateral is required for bigger loan
                                    amount (such as land title, house and lot,
                                    and the likes)
                                  </p>
                                </div>
                        ...
                        const steps = [
                          ...
                          {
                            label: "Supporting Documents Here",
                            content: () => {
                  ...
                  <div className="flex flex-col items-center justify-center h-200 bg-gray-100 p-4">
                    <div className="bg-white shadow-lg rounded-lg p-6 text-center max-w-md w-full">
                      ...
                      <p className="text-gray-600 mt-2">
                        Thank you for applying. Your loan application has been
          ...
          <dialog id="viewLoan" className="modal">
            <div className="modal-box w-11/12 max-w-5xl">
              ...
              <div
                className="modal-header flex items-center justify-between p-4 bg-gradient-to-r from-gray-200 to-gray-300
      z-10 text-blue-950 border bg-white text-blue-950  rounded-t-lg"
              ...
              <div className="p-2 space-y-4 md:space-y-6 sm:p-4">
                ...
                {selectedLoan.loan_application_id && (
                  <Formik
                    initialValues={{
                      calculatorLoanAmmount: parseFloat(
                        selectedLoan.loan_amount
                      ),
                      calculatorInterestRate: parseFloat(
                        selectedLoan.interest_rate
                      ),
                      calculatorMonthsToPay: parseFloat(
