    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ row, value }) => {
          return (
            value && (
              <span className="">{format(value, "MMM dd, yyyy hh:mm a")}</span>
            )
          );
        },
      },
  ...
  const formikConfig = (selectedUser, loanType) => {
    ...
    if (currentStep === 0) {
      ...
      if (loanType === "NON-EMPLOYEE LOAN") {
        PersonalInfoTabValidation = {
          ...
          has_business: Yup.string().required(
            "Please specify if you own a business"
          ),
          type_of_business: Yup.string().required(
            "Business type is required if you own a business"
          ),
          ...
          relationship_to_loan_guarantor: Yup.string().required(
            "Please specify who will help pay your loan if a problem occurs"
          ),

          loan_guarantor: Yup.string().required(
            "Loan guarantor name is required"
          ),
        ...
        PersonalInfoTabValidation = {
          ...
          // }),
          pensioner: Yup.string().required(
            "Please select if you are a pensioner"
          ),
          ...
          loan_security: Yup.string().required(
            "Loan security (ATM/Passbook) is required"
          ),
        };
      }
      ...
      PersonalInfoTabValidation = {
        disbursement_type: Yup.string().required(
          "Disbursement type is required"
        ),
        disbursement_bank_or_wallet_name: Yup.string().when(
          "disbursement_type",
          {
            is: (val) => val === "E-WALLET/BANK TRANSFER", // Condition
            then: (schema) =>
              schema.required("Bank/E-Wallet Name isPco required"), // Apply validation
    ...
    return {
      ...
      onSubmit: async (values, { setFieldError, setSubmitting, resetForm }) => {
        ...
        await axios({
          method: "POST",
          url: "/api/admin/loan/upload-files/uploadSupportingDocuments",
          headers: {
            "Content-Type": "multipart/form-data",
          },
          data: formData,
          ...
          <div className="space-y-2">
            ...
            <div className="relative h-48 rounded-lg border border-gray-300 overflow-hidden bg-gray-100 flex justify-center items-center">
              ...
              <button
                ...
                className="absolute top-2 right-2 bg-red-500 text-white rounded-full w-10 h-10 flex items-center justify-center hover:bg-red-600"
                  ...
                  <Formik {...formikConfig(selectedUser, loanType)}>
                    {({
                            ...
                            <Form className="">
                              <Radio
                                ...
                                options={[
                                  {
                                    value:
                                      "GOVERNMENT AND PRIVATE EMPLOYEES LOAN",
                                    label:
                                      "GOVERNMENT AND PRIVATE EMPLOYEES LOAN",
                                  },
                                  {
                                    value: "NON-EMPLOYEE LOAN",
                                    label: "NON-EMPLOYEE LOAN",
                                  },
                                ]}
                              ...
                              {values.loan_type ===
                                ...
                                <div>
                                  <div class="flex justify-center items-center">
                                    <h1 class="text-center font-bold text-blue-950">
                                      {values.loan_type}
                                    </h1>
                                  </div>
                                  ...
                                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2 ">
                                    <div className="mt-4">
                                      <Radio
                                        ...
                                        value={
                                          values.relationship_to_loan_guarantor
                                        }
                                        setFieldValue={setFieldValue}
                                        onBlur={handleBlur}
                                        options={[
                      ...
                      const SupportingDocuments = () => {
                        ...
                        return (
                          <div className="space-y-4 mt-4">
                            ...
                            <div
                              className={`${
                                hasError1 ? "border-2 border-red-500 p-4" : ""
                              } rounded-lg`}
                            >
                              <DropzoneArea
                                  ...
                                  {values.disbursement_type === "CASH" && (
                                    <div className="mt-4 col-span-2">
                                      <div className="bg-yellow-100 border border-yellow-500 text-yellow-700 p-4 rounded">
                                        ...
                                        <p>
                                          Please visit the office to collect
                                          your cash disbursement upon approval.
                                        </p>
                                      </div>
                                    </div>
                                  )}
                      ...
                      const Confirmation = () => {
                        ...
                        return (
                          <div className="mt-8 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-4 rounded-lg shadow-md w-full">
                            <div className="flex justify-between items-start">
                              <div>
                                <h3 className="text-lg font-semibold">Note</h3>
                                <p className="mt-2">
                                  Collateral is required for bigger loan amount
                                  (such as land title, house and lot, and the
                                  likes)
                                </p>
                              </div>
                              <button className="text-yellow-700 hover:text-yellow-900 font-semibold"></button>
                            </div>
                            <div className="flex items-center mt-4">
                              ...
                              <label
                                htmlFor="terms"
                                className="ml-2 text-smf text-gray-700"
                              >
                                I further certify that the cited information's
                                are the best of my knowledge tru, correct, and
                                voluntary
                              </label>
                            </div>
                          </div>
                      ...
                      const nextStep = async () => {
                        ...
                        if (currentStep === 2) {
                          const validateFields = (fields, setFieldError) => {
                            const fieldErrors = {
                              borrowerValidID:
                                "Borrower's Valid ID is required",
                              bankStatement: "Bank Statement is required",
                              coMakersValidID:
                                "Co-maker's Valid ID is required",
                            };
                            ...
                            <div className="">
                              ...
                              <div className="flex justify-between mt-4">
                                ...
                                {currentStep < steps.length - 1 ? (
                                  <button
                                    onClick={nextStep}
                                    className="btn btn-primary bg-buttonPrimary"
                                  >
                                    Next
                                  </button>
                                ) : (
            ...
            <div className="modal-box w-11/12 max-w-5xl">
              <button
                ...
                onClick={() => {
                  ...
                  const fieldsToClear = ["borrowerValidID"];

                  setFiles((prev) => {
                    const updated = { ...prev };
                    fieldsToClear.forEach((f) => (updated[f] = null));
                    return updated;
                  });
                  ...
                  setPreviews((prev) => {
                    ...
                    fieldsToClear.forEach((f) => {
                      if (prev[f]) URL.revokeObjectURL(prev[f]);
                      updated[f] = null;
                    });
                    return updated;
                  });
                ...
                <Formik
                  initialValues={{
                    ...
                    disbursement_bank_or_wallet_name:
                      selectedLoan.disbursement_bank_or_wallet_name,
                    disbursement_account_name:
                      selectedLoan.disbursement_account_name,
                  ...
                  validationSchema={Yup.object({
                    ...
                    // }),
                    borrowerValidID: Yup.string().required("Required"),
                  })}
                  onSubmit={async (values, { setSubmitting, resetForm }) => {
                    const formData = new FormData();
                    const recipient_name = `${selectedLoan.first_name} ${selectedLoan.last_name}`;
                    const recipient_account_number =
                      selectedLoan.contact_number;
                    ...
                    formData.append(
                      "payment_channel",
                      values.disbursement_bank_or_wallet_name
                    );
                              ...
                              values.disbursement_type === "CASH" && (
                                <div className="mt-4 col-span-2">
                                  <div className="bg-yellow-100 border border-yellow-500 text-yellow-700 p-4 rounded">
                                    ...
                                    <p>
                                      {" "}
                                      Please double-check the cash before giving
                                      it to the borrower.
                                    </p>
                                  </div>
                                </div>
                              ...
                              <div>
                                <div className="mt-4 col-span-2">
                                  <div className="bg-yellow-100 border border-yellow-500 text-yellow-700 p-4 rounded">
                                    <p className="font-semibold">Important:</p>
                                    <p>
                                      Please carefully review and double-check
                                      the bank or e-wallet details.
                                      Disbursements are irreversible once sent.
                                    </p>
                                  </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
                                  ...
                                  <InputText
                                    ...
                                    name="disbursement_account_name"
                                    type="text"
                                    value={`${selectedLoan.first_name} ${selectedLoan.last_name}`}
                                    onBlur={handleBlur}
                                  />
                                  <InputText
                                    isReadOnly
                                    ...
                                    name="disbursement_account_number"
                                    type="text"
                                    value={`${selectedLoan.contact_number}`}
                                    onBlur={handleBlur}
                                    // onChange={(e) => setFieldValue('disbursement_account_number', e.target.value)}
                                  />
                                </div>
                          ...
                          <div key={1} className="flex flex-col items-center">
                            ...
                            <span className="mt-3 text-sm text-gray-600 font-medium">
                              ...
                              <div
                                className={`${
                                  hasError1
                                    ? "space-y-4 p-4 border-2 rounded border-red-500"
                                    : ""
                                }`}
                              >
                                <DropzoneArea
