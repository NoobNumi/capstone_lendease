...
const LoanEvaluationResult = ({ result, loanDetails }) => {
  ...
  const { approved, message, breakdown, overallApprovalPercentage } =
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-xl">
        ...
        <div className="mt-8 bg-blue-50 p-4 rounded-lg">
          ...
          <p className="text-sm text-blue-600">
            The overall score is a weighted average of four key factors: Credit
            Score (30%), Monthly Income (25%), Loan-to-Income Ratio (25%), and
            Employment History (20%). A minimum score of 70% is required for
            automatic approval.
          </p>
        </div>
      </div>
...
function LoanManagementTabs({ loanDetails, formikProps, rowIndex }) {
  ...
  const documents = [
    ...
    {
      src: loanDetails.co_makers_valid_id,
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4">
      <div className="bg-white shadow-lg rounded-xl overflow-hidden">
        ...
        {loanDetails.proof_of_disbursement && (
          <div className="mt-4 col-span-2 mb-2">
            <div className="bg-green-100 border border-green-500 text-green-700 p-4 rounded">
              <p className="font-semibold">Info:</p>
              <p>
                Congratulations! This loan has been approved and successfully
                disbursed.You can now check the payment schedule and make an
              ...
              >
                <InfoGrid>
                  <InfoItem
                    ...
                    value={userDetails.employment_status}
                  />
                  <InfoItem
                  ...
                  <InfoItem
                    label="Credit Score"
                    value={userDetails.credit_score}
                  />
                </InfoGrid>
              </Section>
              ...
              {loanDetails.loan_id && (
                <ToPrint
                  calculatorInterestRate={
                    formikProps.values.calculatorInterestRate
                  }
                  selectedLoan={loanDetails}
                  calculatorLoanAmmount={
                    formikProps.values.calculatorLoanAmmount
                  }
                  calculatorMonthsToPay={
                    formikProps.values.calculatorMonthsToPay
                  }
...
const TopSideButtons = ({
  ...
  let canApprove =
    loggedInUser.role === "Loan Officer" || loggedInUser.role === "Admin";
  return (
    <div className="inline-block float-right">
      {canApprove && (
        <div className="flex space-x-4">
          ...
          <button
            style={{ backgroundColor: "#59B259" }}
            className="btn flex items-center font-bold text-white rounded-md 
"
            onClick={() => {
          ...
          >
            <i className="fa-solid fa-eye mr-1 fa-md"></i>
            <span>View</span>
          </button>
  ...
  const formikConfig = (interest_rate) => {
    ...
    return {
      initialValues: {
        ...
        calculatorInterestRate:
          (interest_rate || 3) * loanDetails.repayment_schedule_id,
            ...
            return (
              ...
              >
                ...
                <dialog id="confirmationModal" className="modal">
                  <div className="modal-box w-11/12 max-w-2xl overflow-hidden">
                    <button
                    ...
                    <div
                      className="p-2 space-y-4 md:space-y-6 sm:p-4 overflow-y-scroll"
                    ...
                    <div>
                      {paymentStatus === "success" ? (
                        <>
                          ...
                          <span>
                            Payment completed successfully! Your loan records
                            have been updated.
                          </span>
                        </>
                      ) : (
