...
import { FaShieldAlt, FaClock, FaChartLine, FaBars, FaTimes, FaImage } from 'react-icons/fa';
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/login" className="btn btn-outline bg-blue-950 text-white hover:scale-105 transition-transform duration-300">
                Login
              </Link>
            </nav>
        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              variants={fadeInUp}
            >
              We empower Filipinos by providing accessible, affordable, and personalized financial solutions that support individuals, families, and businesses in achieving their financial goals.
            </motion.p>
            <motion.div
      ...
      <section ref={aboutRef} className="py-16 bg-base-100 scroll-mt-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-8">About RAZV Lending Corporation</h2>
            <p className="mb-6 text-lg text-gray-600">
              RAZV Lending Corporation is a trusted and innovative financial services provider committed to
              empowering individuals, families, and businesses by offering flexible lending solutions.
              With a strong foundation in customer service and financial expertise, we strive to meet
              the diverse needs of our clients with speed, reliability, and care.
            </p>
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <div className="card bg-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                <div className="card-body">
                  ...
                  <h3 className="card-title text-xl mb-4 justify-center">Our Mission</h3>
                  <p className="text-gray-600">
                    Our mission is to offer accessible and affordable financial solutions that make a
                    positive impact on the lives of our customers. We aim to create lasting relationships
                    with our clients by providing personalized services that cater to their unique
                    financial needs.
                  </p>
                </div>
              </div>
              <div className="card bg-white hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                <div className="card-body">
                  ...
                  <h3 className="card-title text-xl mb-4 justify-center">Our Vision</h3>
                  <p className="text-gray-600">
                    To be the leading lending partner in the industry by continuously adapting to the
                    changing needs of our customers, while maintaining the highest standards of
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-white text-lg max-w-2xl mx-auto">
              Experience the difference with our innovative lending solutions designed with you in mind
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Security protocols to protect your data and transactions",
                color: "from-blue-500 to-blue-50",
                lightColor: "bg-blue-50",
                iconColor: "text-blue-500",
                image: "https://img.freepik.com/free-vector/flat-background-safer-internet-day_23-2151127503.jpg?t=st=1740972756~exp=1740976356~hmac=77b5ec385d1b14f5b6e8d8bc1c03037d6909b572beb7e86abb13a179aa25ac13&w=1380",
              ...
              },
              {
                ...
                image: "https://img.freepik.com/free-vector/speed-test-concept-illustration_114360-3267.jpg?t=st=1740972884~exp=1740976484~hmac=13caab3dec14f511f538ff557fb5fd100aeb8c73f26478da5192eb61fbc9f272&w=900",
              ...
              },
              {
                ...
                image: "https://img.freepik.com/free-vector/businessman-meditates-harmony-wellbeing_88138-507.jpg?t=st=1740972942~exp=1740976542~hmac=894cedae1ed6753e89e35f847e129a4ee43169e8562534496e0a8978a17fcf3e&w=1380",
                ...
                >
                  ...
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className={`w-16 h-16 ${feature.lightColor} rounded-full flex items-center 
                  ...
                  <div className="card-body p-6">
                    <h3 className="card-title text-xl font-bold text-center justify-center mb-3
                                 group-hover:text-blue-950 transition-colors duration-300 text-blue-950"
                    >
                      {feature.title}
                    </h3>
                    <p className="text-center text-gray-600 group-hover:text-gray-700 
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            {[
              ...
              >
                <div className="card-body p-6">
                  <h3 className="card-title text-xl font-semibold text-center mb-4">{service.title}</h3>
