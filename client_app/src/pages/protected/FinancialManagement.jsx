...
const FinancialManagement = () => {
  ...
  const loadMoneyIn = async (page = 1) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        dispatch(
          showNotification({
            message: "Failed to load repayment data",
            type: "error",
          })
        );
      }
      ...
      dispatch(
        showNotification({
          message: "Error loading repayment data",
          type: "error",
        })
      );
    } finally {
  ...
  const loadMoneyOut = async (page = 1) => {
    ...
    try {
      ...
      dispatch(
        showNotification({
          message: "Error loading disbursement data",
          type: "error",
        })
      );
    } finally {
  ...
  const loadInterestData = async () => {
    ...
    try {
      ...
      dispatch(
        showNotification({
          message: "Error loading interest data",
          type: "error",
        })
      );
    } finally {
  ...
  const loadOutstandingLoans = async (
    ...
    try {
      ...
      if (response.data.success) {
        console.log("Outstanding Loans Data:", response.data.data);
        setOutstandingLoans(response.data.data);
      } else {
        dispatch(
          showNotification({
            message: "Failed to load outstanding loans",
            type: "error",
          })
        );
      }
      ...
      dispatch(
        showNotification({
          message: "Error loading outstanding loans",
          type: "error",
        })
      );
    } finally {
  ...
  const generateReport = async (format = "csv") => {
    try {
      ...
      dispatch(
        showNotification({ message: "Error generating report", type: "error" })
      );
    }
  };
  ...
  const outstandingColumns = [
    ...
    },
    {
      ...
      Cell: ({ value }) => {
        ...
        if (value <= 7)
          return <span className="text-yellow-500">{value} days</span>;
        if (value <= 30)
          return <span className="text-orange-500">{value} days</span>;
      ...
      <TitleCard title="Financial Management" topMargin="mt-2">
            ...
            {loading.overview ? (
              ...
              <div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value text-red-400">
                        {formatAmount(overview.moneyOut.totalDisbursed)}
                      </div>
                      <div className="stat-desc">
                        {overview.moneyOut.disbursementCount} disbursements
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value text-success">
                        {formatAmount(overview.moneyIn.totalRepaid)}
                      </div>
                      <div className="stat-desc">
                        {overview.moneyIn.paymentCount} payments
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value text-info">
                        {formatAmount(overview.interestEarned)}
                      </div>
                  ...
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value text-warning">
                        {formatAmount(overview.outstandingBalance)}
                      </div>
                  ...
                  <div className="stats shadow">
                    <div className="stat">
                      <div className="stat-title">Remaining Capital</div>
                      <div className="stat-value text-warning">
                        {formatAmount(remainingCapital)}
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-4">
                  {/* Company Fund Gauge (Semi-Circle) */}
                  <div className="card bg-base-100 shadow-xl mb-6">
                    <div className="card-body h-full flex flex-col justify-between">
                      <h2 className="card-title">Company Fund Utilization</h2>
                      ...
                      <div className="flex-1 flex items-center justify-center">
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            <Pie
                              data={[
                                { name: "Remaining", value: remainingCapital },
                                { name: "Used", value: usedCapitalGraph },
                              ]}
                              cx="50%"
                              cy="100%"
                              startAngle={180}
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart
                            data={[
                              {
                                name: "Disbursed",
                                value: overview.moneyOut.totalDisbursed,
                              },
                              {
                                name: "Repaid",
                                value: overview.moneyIn.totalRepaid,
                              },
                              {
                                name: "Interest",
                                value: overview.interestEarned,
                              },
                              {
                                name: "Outstanding",
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="card bg-base-100 shadow-xl">
                    <div className="card-body">
                      ...
                      <p>
                        Track all financial transactions and analyze cash flow.
                      </p>
                  ...
                  <div className="card bg-base-100 shadow-xl">
                    <div className="card-body">
                      ...
                      <p>
                        Monitor loans that still have balances to be collected.
                      </p>
                      <div className="card-actions justify-end">
                        <button
                          className="btn btn-primary btn-sm"
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                  <div className="stats shadow">
                    <div className="stat">
                      <div className="stat-title">Total Repaid</div>
                      <div className="stat-value text-success">
                        {formatAmount(moneyIn.summary?.totalAmount || 0)}
                      </div>
                    </div>
                  </div>
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value text-info">
                        {formatAmount(moneyIn.summary?.averageAmount || 0)}
                      </div>
                    </div>
                  </div>
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value text-warning">
                        {formatAmount(moneyIn.summary?.largestAmount || 0)}
                      </div>
                    </div>
                  </div>
                  <div className="stats shadow">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                  <div className="stats shadow">
                    <div className="stat">
                      <div className="stat-title">Total Disbursed</div>
                      <div className="stat-value text-primary">
                        {formatAmount(moneyOut.summary?.totalAmount || 0)}
                      </div>
                    </div>
                  </div>
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value text-info">
                        {formatAmount(moneyOut.summary?.averageAmount || 0)}
                      </div>
                    </div>
                  </div>
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value text-warning">
                        {formatAmount(moneyOut.summary?.largestAmount || 0)}
                      </div>
                    </div>
                  </div>
                  <div className="stats shadow">
        ...
        {activeTab === "interest" && (
          <div>
            ...
            ) : interestData.interestOverTime &&
              interestData.interestOverTime.length > 0 ? (
              <div>
                {/* Summary Card */}
                <div className="stats shadow mb-6 w-full">
                  <div className="stat">
                    ...
                    <div className="stat-value text-success">
                      {formatAmount(
                        interestData.summary?.totalInterestEarned || 0
                      )}
                    </div>
                  ...
                  <div className="stat">
                    ...
                    <div className="stat-value">
                      {formatAmount(
                        interestData.summary?.totalPaymentsReceived || 0
                      )}
                    </div>
                  </div>
                  <div className="stat">
                    ...
                    <div className="stat-value text-primary">
                      {parseFloat(
                        interestData.summary?.interestPercentage || 0
                      ).toFixed(2)}
                      %
                    </div>
                  </div>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          <PieChart>
                            <Pie
                              ...
                              nameKey="loanType"
                            >
                              {interestData.interestByLoanType.map(
                                (entry, index) => (
                                  <Cell
                                    key={`cell-${index}`}
                          ...
                          {interestData.interestByLoanType.map(
                            (item, index) => (
                              <tr key={index}>
                                ...
                                <td>
                                  {parseFloat(item.avgInterestRate).toFixed(2)}%
                                </td>
                                <td>
                                  {(
                                    (item.interestEarned /
                                      interestData.summary
                                        .totalInterestEarned) *
                                    100
                                  ).toFixed(2)}
                                  %
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value text-warning">
                        {formatAmount(
                          outstandingLoans.summary?.totalOutstanding || 0
                        )}
                      </div>
                    </div>
                  </div>
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value">
                        {outstandingLoans.pagination?.total || 0}
                      </div>
                    </div>
                  </div>
                  <div className="stats shadow">
                    <div className="stat">
                      ...
                      <div className="stat-value text-error">
                        {outstandingLoans.summary?.overdueCount || 0}
                      </div>
