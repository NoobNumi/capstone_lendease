...
SELECT loan_officer.*, u.is_verified 
FROM loan_officer LEFT JOIN user_account AS u ON loan_officer.officer_id = u.officer_id ORDER BY loan_officer.registration_date;
